...
pdf('/home/kt-fitz/data/dkl-appleT.pdf')
    interaction.plot(apple$set,apple$assistance,apple$dkl,type = "b",pch = c(21,19),ylab="KL Divergence",xlab="Trial")
...
cat("\n")
cat("############D_KL - SET############ \n")
dklmodela<-aov(apple$dkl~apple$assistance*apple$set+Error(apple$subject/apple$subject))
...
#print(means)
#print(ses)
#print(t.test(subset(apple,apple$set==1&apple$assistance=='hsc')$dkl,subset(apple,apple$set==1&apple$assistance=='walls')$dkl,var.equal = TRUE))
#print(t.test(subset(apple,apple$set==2&apple$assistance=='hsc')$dkl,subset(apple,apple$set==2&apple$assistance=='walls')$dkl,var.equal = TRUE))
#print(t.test(subset(apple,apple$set==3&apple$assistance=='hsc')$dkl,subset(apple,apple$set==3&apple$assistance=='walls')$dkl,var.equal = TRUE))
cat("\n\n")
cat("***************Banana***************\n")
...
cat("\n")
cat("############D_KL - SET############ \n")
dklmodelb<-aov(banana$dkl~banana$assistance*banana$set+Error(banana$subject/banana$subject))
...
#print(means)
#print(ses)
#print(t.test(subset(banana,banana$set==1&banana$assistance=='hsc')$dkl,subset(banana,banana$set==1&banana$assistance=='walls')$dkl,var.equal = TRUE))
#print(t.test(subset(banana,banana$set==2&banana$assistance=='hsc')$dkl,subset(banana,banana$set==2&banana$assistance=='walls')$dkl,var.equal = TRUE))
#print(t.test(subset(banana,banana$set==3&banana$assistance=='hsc')$dkl,subset(banana,banana$set==3&banana$assistance=='walls')$dkl,var.equal = TRUE))
print(t.test(subset(banana,banana$set==1&banana$assistance=='walls')$dkl,subset(banana,banana$set==3&banana$assistance=='walls')$dkl,var.equal = TRUE))
print(t.test(subset(banana,banana$set==1&banana$assistance=='hsc')$dkl,subset(banana,banana$set==3&banana$assistance=='hsc')$dkl,var.equal = TRUE))
cat("\n\n")
cat("***************House***************\n")
...
cat("\n")
cat("############D_KL - SET############ \n")
dklmodelh<-aov(house$dkl~house$assistance*house$set+Error(house$subject/house$subject))
...
#cat("\n")
cat("############D_KL Pixel - SET############ \n")
dklmodelu<-aov(umbrella$dkl~umbrella$assistance*umbrella$set+Error(umbrella$subject/umbrella$subject))
