...
class DrawSimulator{
  ...
  DrawSimulator(ros::NodeHandle* _nh,system *_sys){
...
int main(int argc, char **argv){
  ...
  ros::NodeHandle n;
  DrawSimulator<DoubleInt> sim(&n,&syst1);
  ros::Timer timer = n.createTimer(ros::Duration(DT), &DrawSimulator<DoubleInt>::timercall, &sim);
  ros::spin();
 return 0;
};