...
the end effector as well as the configuration of the cart-pendulum system.
The Marker array is published to Rviz. Markers are updated using a callback
function that takes the custom data collection message as its argument.
